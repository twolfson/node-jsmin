...
var assert = require('assert'),
	jsmin = require('../jsmin'),
	fs = require('fs'),
	jquerySrc = fs.readFileSync('./test_files/jquery.js', 'utf8'),
	expectedJQueryMin1 = fs.readFileSync('./test_files/jquery.min.1.js', 'utf8'),
	expectedJQueryMin2 = fs.readFileSync('./test_files/jquery.min.2.js', 'utf8'),
	expectedJQueryMin3 = fs.readFileSync('./test_files/jquery.min.3.js', 'utf8'),
